...
public:
	...
	bool checkvalidmove(int pieceposition, int newpieceposition, piece pieces[]) {
...
int main()
{
	...
	while (true) {
		...
		int ychoice;
		cin >> ychoice;
		//checking if the piece is theirs, if not, loop the question again
		...
		int newychoice;
		cin >> newychoice;
		//checking if the path to the tile is obstructed or has an enemy on it
